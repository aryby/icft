    ...
    <div class="span9">
        ...
        <div class="heightauto">
            <div class="list_carousel">
                ...
                <p align="justify">
                    <span class="text-info">International Conference on Digital Economy Smart Business & Data Innovation (DESDI'25)</span> aims to serve as a premier interdisciplinary platform for researchers, academics, practitioners, and policymakers to exchange knowledge and discuss emerging trends, challenges, and breakthroughs shaping the digital economy.<br>
                    <br>
        ...
        <div class="accordion">
            <p>
                <strong>
                    ...
                    <span class="post-edit-link">July 05, 2025</span><span class="STYLE3"><br></span><span class="STYLE4"><br></span>
                    Paper/Abstract submission deadline: <br>
                    <span class="STYLE3">September 03, 2025</span><br><br>
                    Notification of acceptance: <br>
                    <span class="STYLE3">September 25, 2025</span><br><br>
                    Registration deadline: <br>
                    <span class="STYLE3">October 03, 2025</span><br><br>
                    DESDI'25 Conference Dates: <br>
                    <span class="STYLE3">October 23-24, 2025</span>
                </strong>
            </p>
            <p>&nbsp;</p>
            <p>
